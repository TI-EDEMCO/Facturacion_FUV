...
services=(
    "microservice-config-0.0.1-SNAPSHOT.jar|https://192.168.56.1:8888/actuator/health|8888"
    "microservice-eureka-0.0.1-SNAPSHOT.jar|https://192.168.56.1:8761/eureka/health|8761"
    "microservice-gateway-0.0.1-SNAPSHOT.jar|https://192.168.56.1:8080/actuator/health|8080"
    "microservice-factura-0.0.1-SNAPSHOT.jar|https://192.168.56.1:8060/actuator/health|8060"
    "microservice-facturacion-especial-0.0.1-SNAPSHOT.jar|https://192.168.56.1:9081/actuator/health|9081"
    "microservice-remitentes-0.0.1-SNAPSHOT.jar|https://192.168.56.1:8070/actuator/health|8070"
    "microservice-security-0.0.1-SNAPSHOT.jar|https://192.168.56.1:8050/actuator/health|8050"
    "microservice.generation-0.0.1-SNAPSHOT.jar|https://192.168.56.1:9092/actuator/health|9092"
    "Operadores-0.0.1-SNAPSHOT.jar|https://192.168.56.1:9091/actuator/health|9091"
    "IntegracionSiesa-0.0.1-SNAPSHOT.jar|https://192.168.56.1:9090/actuator/health|9090"
)

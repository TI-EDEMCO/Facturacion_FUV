...
class AbstractAPI(ABC):
    ...
    def execute(self):
        # Intentamos ejecutar el método data_parameters y guardamos el resultado en la variable Exist_xml
        Exist_xml = self.try_step(self.CheckFile)
        # Devolvemos los datos en formato JSON
        return Exist_xml

    # Definimos el método abstracto CheckFile
    @abstractmethod
    def CheckFile(self):
        pass
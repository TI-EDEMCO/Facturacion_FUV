...
/*
* PostModifyGenerationData Service
*
* Función:
* Realiza una solicitud HTTP para modificar los cálculos relacionados con generación de energía.
...
* ```
*/
const PostModifyGenerationData = async (InfoGeneracion) => {
  try {
    const response = await fetchWithToken('/api/generacion/modify_generacion', {
      method: 'POST',

      body: JSON.stringify(InfoGeneracion)
    })
...
export default PostModifyGenerationData
